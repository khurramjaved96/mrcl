...
class Parser(configargparse.ArgParser):
    def __init__(self):
        ...
        self.add('--plasticity-decay', type=float, nargs='+', help='meta-level outer learning rate', default=[0.999])
